...
class AiCoachSection extends ConsumerWidget {
        ...
        children: [
          ...
          Row(
            children: [
              ...
              if (state.insight == null && !state.isLoading)
                GestureDetector(
                  onTap: () {
                    ref.read(aiCoachProvider.notifier).generateInsight();
                  },
                  child: Container(
          ...
          if (state.isLoading)
            ...
            _buildInsightContent(context, ref, state.insight!)
          else
  ...
  Widget _buildInsightContent(
      BuildContext context, WidgetRef ref, String insight) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Container(
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Text(
              'Tap "Analyze" to get personalized nutrition insights based on today\'s intake.',
              style: TextStyle(
