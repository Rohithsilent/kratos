        ...
        child: Column(
          ...
          children: [
            ...
            GlassTextField(
              ...
              prefixIcon: Icon(Icons.lock_outline_rounded, color: context.customColors.grey500, size: 20),
              suffixIcon: IconButton(
                icon: Icon(_obscure1 ? Icons.visibility_off_rounded : Icons.visibility_rounded, color: context.customColors.grey500, size: 20),
            ...
            GlassTextField(
              ...
              prefixIcon: Icon(Icons.lock_outline_rounded, color: context.customColors.grey500, size: 20),
              suffixIcon: IconButton(
                icon: Icon(_obscure2 ? Icons.visibility_off_rounded : Icons.visibility_rounded, color: context.customColors.grey500, size: 20),
